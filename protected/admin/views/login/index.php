  <body>
        <div id="loginbox">            
            <form id="loginform" class="form-vertical" action="http://themedesigner.in/demo/matrix-admin/index.html">
				 <div class="control-group normal_text"> <h3><img src="<?php echo $this->_theme->baseUrl;?>/img/logo.png" alt="Logo" /></h3></div>
        ...
        <script src="<?php echo $this->_theme->baseUrl;?>/js/jquery.min.js"></script>  
        <script src="<?php echo $this->_theme->baseUrl;?>/js/matrix.login.js"></script> 
    </body>
